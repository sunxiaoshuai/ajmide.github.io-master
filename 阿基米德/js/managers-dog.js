...
function init(){
    ...
    managers.addEventListener('mousemove', handleMouseMove, false);
    managers.addEventListener('mousedown', handleMouseDown, false);
    managers.addEventListener('mouseup', handleMouseUp, false);
    managers.addEventListener('touchstart', handleTouchStart, false);
    managers.addEventListener('touchend', handleTouchEnd, false);
    managers.addEventListener('touchmove',handleTouchMove, false);
    /*
